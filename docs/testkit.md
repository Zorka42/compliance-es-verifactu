...
Response fixtures are minimal field-extraction inputs, not full response-schema fixtures. TEST-prefixed error codes deliberately avoid inventing official catalogue mappings. See the [fixture tests](../verifactu-testkit/src/commonTest/kotlin/dev/verifactu/testkit/VerifactuFixturesTest.kt) and [offline examples](../samples/offline/README.md).
