...
| Typed incidence and subsanation interpretation | AEAT validation catalogue and archived `errores.properties` | catalogue 1.2.2, sections 4.2–4.4; `errores.properties` `2000`–`2009`, `3000`–`3004`, `3500`–`3503`, `4102`–`4141` | `AeatErrorCatalogue.kt`; `AeatResponseParser.kt`; synthetic `AeatResponseFixtures` | `AeatErrorCatalogueTest`; `AeatResponseParserTest`; `VerifactuFixturesTest` | Implemented; no automatic correction workflow | 2026-09-06 |
